...
const Hero = () => {
	return (
		<section
			id="hero"
			className="relative w-full max-w-7xl mx-auto min-h-screen flex flex-col justify-center px-8 py-28 mb-5 overflow-hidden"
		>
			...
			<div className="absolute top-50 left-2 w-full flex justify-between px-35 -z-10 pointer-events-none select-none">
				<span className="text-9xl font-serif text-foreground">Hello,</span>
				<span className="text-9xl font-serif text-foreground">there</span>
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr_1fr] gap-8 items-center w-full">
				...
				<div className="flex flex-col z-10 pt-75 md:items-end text-left md:text-right">
					<p className="text-xl font-medium text-foreground/90 max-w-sm mb-6 leading-relaxed">
